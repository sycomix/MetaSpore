...
sys.path.append('../../../') 
from python.algos.pnn_net import PNN
...
def init_spark():
    subprocess.run(['zip', '-r', 'demo/ctr/pnn/python.zip', 'python'], cwd='../../../')
    spark_confs={
...
def train(spark, trian_dataset, **model_params):
    ...
    module = PNN(use_wide=use_wide, #True
                ...
                product_type=product_type, #'inner' or 'outer'
                ftrl_l1=ftrl_l1,
                ftrl_l2=ftrl_l2,
