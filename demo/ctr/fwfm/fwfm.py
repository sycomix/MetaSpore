...
sys.path.append('../../../')
from python.algos.fwfm_net import FwFM
...
def init_spark():
    subprocess.run(['zip', '-r', 'demo/ctr/fwfm/python.zip', 'python'], cwd='../../../')
    spark_confs={
...
def train(spark, trian_dataset, **model_params):
    module = FwFM(use_wide=use_wide, #True
