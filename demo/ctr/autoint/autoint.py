...
sys.path.append('../../../')
from python.algos.autoint_net import AutoInt
...
def init_spark():
    subprocess.run(['zip', '-r', 'demo/ctr/autoint/python.zip', 'python'], cwd='../../../')
    spark_confs={
...
def train(spark, trian_dataset, **model_params):
    ...
    module= AutoInt(use_wide=use_wide,
