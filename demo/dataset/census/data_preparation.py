...
# This code is adapted from github repository:  https://github.com/PaddlePaddle/PaddleRec/blob/master/datasets/census/data_preparation.py
...
def data_preparation(train_path, test_path, train_data_path, test_data_path):
    ...
    '''
    We don't need to generate one-hot embedding here because Metaspore can handle embedding layer automatically.
    ...
    '''
    transformed_train = train_df
    transformed_other = other_df
...
data_preparation("data/census-income.data", "data/census-income.test", "train_data/",
                 "test_data/")